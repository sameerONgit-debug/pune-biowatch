      ...
      <div className="relative z-10 flex min-h-[600px] flex-col justify-between px-6 py-7 sm:px-9 sm:py-10 lg:px-12 lg:py-12">
        <div className="flex items-start justify-between gap-6">
          ...
          <div className="hidden rounded-2xl border border-white/15 bg-[#051b17]/70 px-3.5 py-3 backdrop-blur-md sm:block">
            ...
            <div className="mt-1.5 flex items-center gap-1.5 text-[10px] font-bold text-[#a8e6b8]"><span className="h-1.5 w-1.5 rounded-full bg-[#a8e6b8]" /> 8 telemetry zones reporting</div>
          </div>
        </div>
        ...
        <div className="grid items-center gap-10 pb-12 pt-16 lg:grid-cols-[1fr_345px] lg:gap-20">
          ...
          <div className="hidden lg:block">
            <div className="rounded-[1.6rem] border border-[#73e5cf]/25 bg-[#061b17]/78 p-4 shadow-2xl backdrop-blur-xl">
              ...
              <div className="mt-5 text-[10px] font-bold uppercase tracking-[0.14em] text-[#719487]">Current focus</div>
              ...
              <div className="mt-5 space-y-2">
                ...
                <div className="flex items-center justify-between rounded-xl border border-white/10 bg-black/15 px-3 py-2.5"><span className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#78988a]">Signals requiring review</span><span className="font-mono text-sm font-extrabold text-[#ff9c88]">03</span></div>
              </div>
